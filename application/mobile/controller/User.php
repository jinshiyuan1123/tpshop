...
class User extends MobileBase
{
    ...
    */
    ...
    public function index()
    {
        ...
        $comment = DB::query("select COUNT(1) as comment from tp_order_goods as og left join tp_order as o on o.order_id = og.order_id where o.user_id = $this->user_id and og.is_send = 1 and og.is_comment = 0 ");  //我的待评论订单
