<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:51:"./application/admin/view2/public\dispatch_jump.html";i:1488176436;}*/ ?>
<!DOCTYPE html>
<html>
  <head>
    <meta charset="UTF-8">
...
<?php }?>      
	    <div class="margin text-center">
	        <div class="copyright">
	            2014-<?php echo date('Y'); ?> &copy; <a href="http://www.tp-shop.cn/">TPSHOP v2.0.0</a>
	            <br/>
	            <a href="http://www.tp-shop.cn/">深圳搜豹网络有限公司</a>出品
	        </div>
	    </div>
    </div><!-- /.login-box -->
