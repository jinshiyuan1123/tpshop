<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:40:"./application/admin/view2/ad\adList.html";i:1488176436;s:44:"./application/admin/view2/public\layout.html";i:1488176436;}*/ ?>
<!doctype html>
<html>
<head>
  ...
  <div class="flexigrid">
      ...
      <div class="sDiv">             
        <div class="sDiv2">
         <select name="pid" class="form-control">
              ...
              <?php if(is_array($ad_position_list) || $ad_position_list instanceof \think\Collection): $k = 0; $__LIST__ = $ad_position_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($k % 2 );++$k;?>
    ...
    <div class="tDiv">
      <div class="tDiv2">
        ...
        <div class="fbutton"><a href="<?php echo U('/Home/Index/index',array('edit_ad'=>1)); ?>"><div class="add" title="首页"><span><i class="fa fa-search"></i>首页</span></div></a></div>
        <div class="fbutton"><a href="<?php echo U('/Mobile/Index/index',array('edit_ad'=>1)); ?>"><div class="add" title="手机首页"><span><i class="fa fa-search"></i>手机首页</span></div></a></div>
        <div class="fbutton"><a href="<?php echo U('/Mobile/Goods/categoryList',array('edit_ad'=>1)); ?>"><div class="add" title="手机分类页"><span><i class="fa fa-search"></i>手机分类页</span></div></a></div>        
      </div>
        ...
        <table>
          <tbody>
            <?php if(is_array($list) || $list instanceof \think\Collection): if( count($list)==0 ) : echo "" ;else: foreach($list as $k=>$vo): ?>
              ...
              <td align="center">
                <div style="text-align: center; width: 100px;">
                  <input type="text" onKeyUp="this.value=this.value.replace(/[^\d]/g,'')" onpaste="this.value=this.value.replace(/[^\d]/g,'')" onChange="changeTableVal('ad','ad_id','<?php echo $vo['ad_id']; ?>','orderby',this)" size="4" value="<?php echo $vo['orderby']; ?>" />
                </div>
              </td>
