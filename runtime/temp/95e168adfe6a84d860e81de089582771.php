<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:42:"./application/admin/view2/tools\index.html";i:1488176436;s:44:"./application/admin/view2/public\layout.html";i:1488176436;}*/ ?>
<!doctype html>
<html>
<head>
				...
				<table>
					...
					<?php if(is_array($list) || $list instanceof \think\Collection): if( count($list)==0 ) : echo "" ;else: foreach($list as $k=>$vo): ?>
						<tr data-id="<?php echo $vo['Name']; ?>">
							...
							<td align="center" class="">
								<div style="text-align: center; width: 200px;"><?php echo $vo['Comment']; ?></div>
							</td>
							<td align="center" class="handle">
								<div style="text-align: center; width: 170px; max-width:170px;">
									<a href="<?php echo U('Tools/optimize',array('tablename'=>$vo['Name'])); ?>" class="btn blue"><i class="fa fa-magic"></i>优化</a>
									<a class="btn red" href="<?php echo U('Tools/repair',array('tablename'=>$vo['Name'])); ?>"><i class="fa fa-wrench"></i>修复</a>
								</div>
							</td>
